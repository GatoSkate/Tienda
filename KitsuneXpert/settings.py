"""
Django settings for KitsuneXpert project.
...
SECRET_KEY = 'django-insecure-%_m#kqhm2&3v3s44ztm)h%ye8!3z($@wc5uc9)tv7w*#57rq7('
...
ROOT_URLCONF = 'KitsuneXpert.urls'
...
WSGI_APPLICATION = 'KitsuneXpert.wsgi.application'
